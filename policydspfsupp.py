...
#  default values
defaultConfigFilename = '/var/local/lib/policyd-spf/config/policy-spf.conf'
defaultConfigData = {
		'debugLevel' : 0,
		'defaultSeedOnly' : 1,
		'configPath' : 'file:///var/local/lib/policyd-spf/config',
		'spfqueryPath' : '/usr/local/lib/policyd-spf/spfquery',
		}
...
def processConfigFile(filename = None, config = None, useSyslog = 1,
	...
	if filename == None: filename = policydspfsupp.defaultConfigFilename
